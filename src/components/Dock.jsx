...
export default function Dock({ dark, setDark }) {
  return (
    <div className="floating-dock">
      ...
      <a href="https://github.com/ChetanaBehere" target="_blank" className="dock-item">
        <FiGithub />
      </a>

      <a href="https://www.linkedin.com/in/chetana-behere-986403330" target="_blank" className="dock-item">
        <FiLinkedin />
      </a>
